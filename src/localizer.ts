...
export function localizeDate(date: Date, locale: string = 'fr-FR'): LocalizedDateComponents {
  ...
  const monthNameShortFormatter = new Intl.DateTimeFormat(locale, { month: 'short' });
